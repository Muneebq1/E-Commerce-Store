...
import { GetAllProducts, DeleteProduct, EditProducts } from '../../../services/admin/home';
    ...
    <div className='all-post'>
      {products.map((eachProduct, i) => (
        <div key={eachProduct._id} className="post">
          ...
          <button onClick={() => {
            DeleteProduct(eachProduct._id).then(setLoadProduct(!loadProduct)).catch((err) => { console.log(err) })
          }}>delete</button>
